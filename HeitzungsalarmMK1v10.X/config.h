...
#pragma config BOR      = BOACTIVE      // Brown-out Reset Enable bits (Brown-out Reset enabled in hardware only and disabled in Sleep mode (SBOREN is disabled))
...
#define _XTAL_FREQ   8000000           //Prozessortakt in MHz
